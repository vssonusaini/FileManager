...
$auth_users = array(
    'admin' => '$2y$10$CRaWe/buOyeBswCvRoHJvumS0AgXh9fb4kq5bSQFpwLFgM5Sd5nXi', //admin@123
    'user' => '$2y$10$qXNFf7r8mWRlMcxuvCVWzuRjJskQYWXo15UlF981VuCuXzTrncfKS' //12345
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                                    ...
                                    <div class="form-group">
                                       <!-- <div class="brand">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h1 class="card-title" style="font-size:50px;"><?php echo APP_TITLE; ?></h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://vssonusaini.github.io/profile.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">V S Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://vssonusaini.github.io/profile.github.io" target="_blank" class="app-v-title"> V S Sonu Saini <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Sonu Saini</p>
                        <p>Mail Us: <a href="mailto:vssonusaini464@gmail.com">vssonusaini464@gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://vssonusaini.github.io/profile.github.io" target="_blank" class="float-right text-muted">V S Sonu Saini <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://vssonusaini.github.io/profile.github.io" target="_blank" class="float-right text-muted">V S Sonu Saini<?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'V S File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with V S Server">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'V S Sonu Saini';      $tr['en']['AppTitle']           = 'V S  File Manager';
